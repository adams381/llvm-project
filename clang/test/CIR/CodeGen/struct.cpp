...
// `CompleteS { int a; char b; }` is 8 bytes (single eightbyte INTEGER
// class).  The calling-convention lowering pass coerces the by-value
// argument to a single `i64` eightbyte, matching OGCG.
