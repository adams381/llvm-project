...
// LLVM: define{{.*}} noundef i32 @_Z13cStyleCasts_0jifsd(i32 noundef %{{[0-9]+}}, i32 noundef %{{[0-9]+}}, float noundef %{{[0-9]+}}, i16 noundef signext %{{[0-9]+}}, double noundef %{{[0-9]+}})
...
// LLVM-LABEL: define{{.*}} void @_Z1fl(i64 noundef %0)
