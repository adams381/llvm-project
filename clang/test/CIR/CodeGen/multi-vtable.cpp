...
// LLVM: define{{.*}} void @_ZN6Father9FatherKeyEv(ptr noundef nonnull align 8 dereferenceable(8) %{{.*}})

// LLVM: define{{.*}} void @_ZN5Child9MotherKeyEv(ptr noundef nonnull align 8 dereferenceable(16) %{{.*}})
