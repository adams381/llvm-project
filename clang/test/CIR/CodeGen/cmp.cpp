...
// LLVM-LABEL: define{{.*}} void @_Z2c0ii(i32 noundef %0, i32 noundef %1){{.*}} {
...
// LLVM-LABEL: define{{.*}} void @_Z11c0_unsignedjj(i32 noundef %0, i32 noundef %1){{.*}} {
...
// LLVM-LABEL: define{{.*}} void @_Z8c0_floatff(float noundef %0, float noundef %1){{.*}} {
...
// LLVM-LABEL: define{{.*}} void @_Z11pointer_cmpPiS_(ptr noundef %0, ptr noundef %1){{.*}} {
...
// LLVM-LABEL: define{{.*}} void @_Z8bool_cmpbb(i1 noundef zeroext %0, i1 noundef zeroext %1){{.*}} {
