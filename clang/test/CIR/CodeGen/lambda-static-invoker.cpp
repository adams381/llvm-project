...
// OGCG:   %[[CALL2:.*]] = call noundef i32 %[[FN]](ptr {{.*}} %[[REF_TMP1]])
...
// lambda invoker
// CIR: cir.func no_inline internal private dso_local @_ZZ2g3vEN3$_08__invokeERKi(%[[REF_I_ARG:.*]]: !cir.ptr<!s32i> {{.*}}) -> (!s32i {llvm.noundef}){{.*}} {
// CIR:   %[[REF_I_ALLOCA:.*]] = cir.alloca {{.*}} ["i", init, const]
// CIR:   %[[RETVAL:.*]] = cir.alloca {{.*}} ["__retval"]
...
// CIR:   cir.func no_inline internal private dso_local @_ZZ2g3vENK3$_0cvPFiRKiEEv(%[[THIS_ARG:.*]]: !cir.ptr<![[REC_LAM_G3]]> {{.*}}) -> (!cir.ptr<!cir.func<(!cir.ptr<!s32i>) -> !s32i>> {llvm.noundef}){{.*}} {
// CIR:   %[[THIS_ALLOCA:.*]] = cir.alloca !cir.ptr<![[REC_LAM_G3]]>, !cir.ptr<!cir.ptr<![[REC_LAM_G3]]>>, ["this", init]
...
// LLVM: define internal noundef ptr @"_ZZ2g3vENK3$_0cvPFiRKiEEv"(ptr noundef nonnull align 1 dereferenceable(1) %[[THIS_ARG:.*]]){{.*}} {
// LLVM:  %[[THIS_ALLOCA:.*]] = alloca ptr
...
// CIR: cir.func{{.*}} @_Z2g3v() -> (!s32i {llvm.noundef}){{.*}} {
...
// LLVM: define dso_local noundef i32 @_Z2g3v(){{.*}} {
// LLVM:   %[[LAM_ALLOCA:.*]] = alloca %[[REC_LAM_G3]]
...
// LLVM: [[SCOPE_BB0]]:
// LLVM:   %[[OPERATOR_RESULT:.*]] = call ptr @"_ZZ2g3vENK3$_0cvPFiRKiEEv"(ptr noundef nonnull align 1 dereferenceable(1) %[[LAM_ALLOCA]])
