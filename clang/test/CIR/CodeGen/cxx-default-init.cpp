...
// LLVM: define{{.*}} void @_ZN8ZeroInitC2Ev(ptr noundef nonnull align 4 dereferenceable(37) %[[THIS_ARG:.*]])
...
// LLVM: define{{.*}} void @_ZN9ValueInitC2Ev(ptr noundef nonnull align 4 dereferenceable(37) %[[THIS_ARG:.*]])
// LLVM:   %[[THIS_ALLOCA:.*]] = alloca ptr
// LLVM:   %[[ITER:.*]] = alloca ptr
// LLVM:   %[[THIS:.*]] = load ptr, ptr %[[THIS_ALLOCA]]
