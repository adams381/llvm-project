...
// CIR-NEXT:   %{{.+}} = cir.cast integral %[[#LHS]] : !cir.int<s, 31, bitint> -> !cir.int<s, 31>
// CIR-NEXT:   %{{.+}} = cir.cast integral %[[#RHS]] : !cir.int<s, 31, bitint> -> !cir.int<s, 31>
// CIR-NEXT:   %[[RES:.+]], %{{.+}} = cir.binop.overflow(add, %{{.+}}, %{{.+}}) : !cir.int<s, 31>, (!cir.int<s, 31, bitint>, !cir.bool)
...
// CIR-NEXT:   %{{.+}} = cir.cast integral %[[#LHS]] : !cir.int<s, 31, bitint> -> !cir.int<s, 31>
// CIR-NEXT:   %{{.+}} = cir.cast integral %[[#RHS]] : !cir.int<s, 31, bitint> -> !cir.int<s, 31>
// CIR-NEXT:   %[[RES:.+]], %{{.+}} = cir.binop.overflow(sub, %{{.+}}, %{{.+}}) : !cir.int<s, 31>, (!cir.int<s, 31, bitint>, !cir.bool)
// CIR-NEXT:   cir.store{{.*}} %[[RES]], %[[#RES_PTR]] : !cir.int<s, 31, bitint>, !cir.ptr<!cir.int<s, 31, bitint>>
//      CIR: }
...
// CIR-NEXT:   %{{.+}} = cir.cast integral %[[#LHS]] : !cir.int<s, 31, bitint> -> !cir.int<s, 31>
// CIR-NEXT:   %{{.+}} = cir.cast integral %[[#RHS]] : !cir.int<s, 31, bitint> -> !cir.int<s, 31>
// CIR-NEXT:   %[[RES:.+]], %{{.+}} = cir.binop.overflow(mul, %{{.+}}, %{{.+}}) : !cir.int<s, 31>, (!cir.int<s, 31, bitint>, !cir.bool)
// CIR-NEXT:   cir.store{{.*}} %[[RES]], %[[#RES_PTR]] : !cir.int<s, 31, bitint>, !cir.ptr<!cir.int<s, 31, bitint>>
//      CIR: }
