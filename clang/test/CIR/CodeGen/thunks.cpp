...
// Aggregate-return thunk: sret pointer (%arg0) and this (%arg1).
// CIR: cir.func {{.*}} @_ZThn8_N5Test51C1hEv(%arg0: !cir.ptr<{{[^,]+}} {{.*}}llvm.sret{{.*}}, %arg1: !cir.ptr<
...
// LLVM: define {{.*}} void @_ZThn8_N5Test51C1hEv(ptr{{.*}}sret(%"struct.Test5::NonTrivial"){{.*}}, ptr{{.*}})
// LLVM:   %[[L5_THIS:.*]] = load ptr, ptr
// LLVM:   %[[L5_ADJ:.*]] = getelementptr i8, ptr %[[L5_THIS]], i64 -8
// LLVM:   call void @_ZN5Test51C1hEv(ptr{{.*}}sret(%"struct.Test5::NonTrivial"){{.*}}, ptr{{.*}} %[[L5_ADJ]])
// LLVM:   ret void
