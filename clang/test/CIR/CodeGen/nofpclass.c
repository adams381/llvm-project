...
// CallConvLowering coerces `_Complex double` to an anonymous two-field
// record (`{!cir.double, !cir.double}`) matching classic Clang's
// `{ double, double }` x86_64 SysV return convention.
