...
/// For an indirect call, prepend the callee function pointer (bitcast to
/// match the rewritten argument/return types) as operand 0 so
/// CallOp::create rebuilds it as an indirect call.  No-op for direct calls.
