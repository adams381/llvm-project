...
long double ld;
// CIR: cir.global external @ld = #cir.fp<0.000000e+00> :
...
char **cpp;
// CIR: cir.global external @cpp = #cir.ptr<null> :
// CIR-SAME: !cir.ptr<!cir.ptr<!s8i>>{{.*}}
...
int (*fpii)(int) = 0;
// CIR: cir.global external @fpii = #cir.ptr<null> :
// CIR-SAME: !cir.ptr<!cir.func<(!s32i) -> !s32i>>{{.*}}
// LLVM: @fpii = global ptr null, align 8
// OGCG: @fpii = global ptr null, align 8

void (*fpvar)(int, ...);
// CIR: cir.global external @fpvar = #cir.ptr<null> :
// CIR-SAME: !cir.ptr<!cir.func<(!s32i, ...)>>{{.*}}
