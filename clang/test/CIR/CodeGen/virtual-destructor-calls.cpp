...
// LLVM:   call void @_ZN1AD2Ev(ptr noundef nonnull align 8 dead_on_return(8) dereferenceable(8) {{.*}})
...
namespace PR12798 {
  ...
  // LLVM:   call void @_ZN7PR127981AD1Ev(ptr noundef nonnull align 8 dead_on_return(8) dereferenceable(8) {{.*}})
