...
///
/// DictionaryAttr::get asserts that names are unique, and an attribute this
/// function sets can already be present: CIRGen marks a scalar parameter
/// llvm.noundef, and the ABI can then pass that parameter byval, which wants
/// llvm.noundef too.
