...
// CIR-LABEL: cir.func no_inline dso_local @_Z17noinline_functioni(%arg0: !s32i {{.*}}) -> (!s32i {llvm.noundef})

// CIR-LABEL: cir.func dso_local @_Z16regular_functioni(%arg0: !s32i {{.*}}) -> (!s32i {llvm.noundef})
// CIR-NOT: no_inline
// CIR-NOT: always_inline
// CIR-NOT: inline_hint
// CIR-SAME: {

// CIR-LABEL: cir.func{{.*}} always_inline {{.*}}@_Z22always_inline_functioni(%arg0: !s32i {{.*}}) -> (!s32i {llvm.noundef})

// CIR-LABEL: cir.func{{.*}} inline_hint {{.*}}@_Z20inline_hint_functioni(%arg0: !s32i {{.*}}) -> (!s32i {llvm.noundef})
