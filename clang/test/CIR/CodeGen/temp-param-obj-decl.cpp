...
//
// LLVM: %[[COERCE:.*]] = alloca %struct.HasMem
// LLVM: %[[RET_ALLOCA:.*]] = alloca %struct.HasMem
// LLVM: call void @llvm.memcpy.p0.p0.i64(ptr {{.*}}%[[RET_ALLOCA]], ptr {{.*}}@_ZTAXtl6HasMemLi2EEE, i64 4, i1 false)
// LLVM: %[[LOAD_RET:.*]] = load %struct.HasMem, ptr %[[RET_ALLOCA]]
// LLVM: store %struct.HasMem %[[LOAD_RET]], ptr %[[COERCE]]
// LLVM: %[[TO_RET:.*]] = load i32, ptr %[[COERCE]]
// LLVM: ret i32 %[[TO_RET]]

// OGCG: %[[RET_ALLOCA:.*]] = alloca %struct.HasMem
// OGCG: call void @llvm.memcpy.p0.p0.i64(ptr {{.*}}%[[RET_ALLOCA]], ptr {{.*}}@_ZTAXtl6HasMemLi2EEE, i64 4, i1 false)
