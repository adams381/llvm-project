...
// LLVM:   %[[INLINE_CALL:.+]] = call i32 @_ZNK15inline_operatorcviEv(ptr noundef nonnull align 1 dereferenceable(1) %[[I_ALLOCA]])
// LLVM:   store i32 %[[INLINE_CALL]], ptr %[[X_ALLOCA]]
// LLVM:   %[[OUTLINE_CALL:.+]] = call i32 @_ZN20out_of_line_operatorcviEv(ptr noundef nonnull align 1 dereferenceable(1) %[[O_ALLOCA]])
