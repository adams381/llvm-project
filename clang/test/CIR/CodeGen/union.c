...
// LLVM-NEXT:   %[[LOADED:.*]] = load %union.U2, ptr %[[COERCE]], align 8
// LLVM-NEXT:   %[[U:.*]] = alloca %union.U2, i64 1, align 8
// LLVM-NEXT:   store %union.U2 %[[LOADED]], ptr %[[U]], align 8
...
// CIR-NEXT:   %[[COERCE:.*]] = cir.alloca "coerce" align(8) : !cir.ptr<!cir.int<u, 40>>
...
// CIR-NEXT:   %[[LOADED:.*]] = cir.load %[[CAST]] : !cir.ptr<!rec_U3>, !rec_U3
// CIR-NEXT:   %[[U:.*]] = cir.alloca "u" align(1) init : !cir.ptr<!rec_U3>
// CIR-NEXT:   cir.store{{.*}} %[[LOADED]], %[[U]] : !rec_U3, !cir.ptr<!rec_U3>
// CIR-NEXT:   %[[ZERO:.*]] = cir.const #cir.int<0> : !s8i
...
// LLVM-NEXT:   %[[LOADED:.*]] = load %union.U3, ptr %[[COERCE]], align 1
// LLVM-NEXT:   %[[U:.*]] = alloca %union.U3, i64 1, align 1
// LLVM-NEXT:   store %union.U3 %[[LOADED]], ptr %[[U]], align 1
...
// CIR-NEXT:   %[[LOADED:.*]] = cir.load %[[CAST]] : !cir.ptr<!rec_U4>, !rec_U4
// CIR-NEXT:   %[[U:.*]] = cir.alloca "u" align(4) init : !cir.ptr<!rec_U4>
// CIR-NEXT:   cir.store{{.*}} %[[LOADED]], %[[U]] : !rec_U4, !cir.ptr<!rec_U4>
...
// LLVM-NEXT:   %[[COERCE:.*]] = alloca i64, i64 1, align 8
// LLVM-NEXT:   store i64 %[[ARG]], ptr %[[COERCE]], align 8
// LLVM-NEXT:   %[[LOADED:.*]] = load %union.U4, ptr %[[COERCE]], align 4
// LLVM-NEXT:   %[[U:.*]] = alloca %union.U4, i64 1, align 4
// LLVM-NEXT:   store %union.U4 %[[LOADED]], ptr %[[U]], align 4
