...
// CIR-SAME: %[[ARG0:.*]]: !s32i {llvm.noundef} {{.*}}) -> (!s32i {llvm.noundef}){{.*}}{
...
// CIR-SAME: %[[ARG0:.*]]: !s32i {llvm.noundef} {{.*}}, %[[ARG1:.*]]: !s32i {llvm.noundef} {{.*}}) -> (!s32i {llvm.noundef}){{.*}}{
...
// LLVM-SAME: i32 noundef %[[ARG0:.*]], i32 noundef %[[ARG1:.*]])
// LLVM: %[[A:.*]] = alloca i32
// LLVM: %[[B:.*]] = alloca i32
// LLVM: %[[RETVAL:.*]] = alloca i32
...
// LLVM-LABEL: define{{.*}} void @_Z23test_cond_lvalue_assignb(i1 noundef zeroext %0)
// LLVM: %[[FLAG:.*]] = alloca i8
// LLVM: %[[A:.*]] = alloca i32
// LLVM: %[[B:.*]] = alloca i32
...
// LLVM-LABEL: define{{.*}} noundef nonnull align 4 dereferenceable(4) ptr @_Z20test_cond_lvalue_refbii(i1 noundef zeroext %0, i32 noundef %1, i32 noundef %2)
// LLVM: %[[COND:.*]] = alloca i8
// LLVM: %[[X:.*]] = alloca i32
// LLVM: %[[Y:.*]] = alloca i32
...
// LLVM-LABEL: define{{.*}} void @_Z25test_cond_lvalue_compoundb(i1 noundef zeroext %0)
// LLVM: %[[FLAG:.*]] = alloca i8
// LLVM: %[[A:.*]] = alloca i32
// LLVM: %[[B:.*]] = alloca i32
// LLVM: %[[FLAG_VAL:.*]] = load i8, ptr %[[FLAG]]
