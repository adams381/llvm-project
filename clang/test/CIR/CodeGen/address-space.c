...
// CIR: cir.func {{.*}} @foo(%arg0: !cir.ptr<!s32i, target_address_space(1)> {llvm.noundef}
...
// CIR: cir.func {{.*}} @bar(%arg0: !cir.ptr<!s32i, target_address_space(0)> {llvm.noundef}
...
// CIR: cir.func {{.*}} @baz(%arg0: !cir.ptr<!s32i> {llvm.noundef}
