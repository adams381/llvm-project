...
// CIR-NEXT:   %[[COERCE_CAST:.*]] = cir.cast bitcast %[[COERCE]] : !cir.ptr<!rec_S> -> !cir.ptr<!u64i>
// CIR-NEXT:   %[[COERCE_LOAD:.*]] = cir.load %[[COERCE_CAST]] : !cir.ptr<!u64i>, !u64i
// CIR-NEXT:   cir.return %[[COERCE_LOAD]]
...
// CIR-NOELIDE-NEXT:   %[[COERCE_CAST:.*]] = cir.cast bitcast %[[COERCE]] : !cir.ptr<!rec_S> -> !cir.ptr<!u64i>
// CIR-NOELIDE-NEXT:   %[[COERCE_LOAD:.*]] = cir.load %[[COERCE_CAST]] : !cir.ptr<!u64i>, !u64i
// CIR-NOELIDE-NEXT:   cir.return %[[COERCE_LOAD]]
...
// LLVM-NEXT:   store %struct.S %[[RET]], ptr %[[COERCE]]
// LLVM-NEXT:   %[[COERCE_LOAD:.*]] = load i64, ptr %[[COERCE]]
// LLVM-NEXT:   ret i64 %[[COERCE_LOAD]]
...
// CIR: cir.func {{.*}} @_Z9test_nrvov(%arg0: !cir.ptr<!rec_NonTrivial>
...
// CIR:       cir.call @_ZN10NonTrivialD1Ev(%arg0)
// CIR:     }
// CIR:     cir.yield
// CIR:   }
//
...
// LLVM: define {{.*}} void @_Z9test_nrvov(ptr {{.*}} sret(%struct.NonTrivial) {{.*}} %[[RESULT:.*]])
